...
public:
	...
	UPROPERTY(EditAnywhere, config, Category = "Darwin|LogSettings")
	...
	UPROPERTY(EditAnywhere, config, Category = "Darwin|LogSettings", DisplayName = "Default Color")
	...
	UPROPERTY(EditAnywhere, config, Category = "Darwin|LogSettings", meta = (EditCondition = "bEnableSpecifiers"))
	TEnumAsByte<ELoggingOptions> DisplaySpecifiersIn = LO_Console;

	// The tag specifers to use when logging in these categories
	UPROPERTY(EditAnywhere, config, Category = "Darwin|LogSettings", EditFixedSize = 5, meta = (EditCondition = "bEnableSpecifiers"))
	...
	UPROPERTY(EditAnywhere, config, Category = "Darwin|LogSettings", meta = (EditCondition = "bLogContext"))
