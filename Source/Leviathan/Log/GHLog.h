...
#include "GHDebugLogSettings.h"
#include "UObject/Package.h"
#include "Engine/EngineTypes.h"
#include <chrono>
#include "GHLog.generated.h"
...
DECLARE_LOG_CATEGORY_EXTERN(LogHook, Log, All)


// 只用于C++中的宏
#define LOG_DEFAULT_DISPLAY_TIME	(15.f)
...
#define LOG_INFO(FormatString, ...) UGHLog::Info(FString::Printf(TEXT(FormatString), ##__VA_ARGS__ ), LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_INFO_CONSOLE(FormatString, ...) UGHLog::Info(FString::Printf(TEXT(FormatString), ##__VA_ARGS__ ), LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_INFO_VIEWPORT(FormatString, ...) UGHLog::Info(FString::Printf(TEXT(FormatString), ##__VA_ARGS__ ), LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_WARNING(FormatString, ...) UGHLog::Warning(FString::Printf(TEXT(FormatString), ##__VA_ARGS__ ), LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_WARNING_CONSOLE(FormatString, ...) UGHLog::Warning(FString::Printf(TEXT(FormatString), ##__VA_ARGS__ ), LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_WARNING_VIEWPORT(FormatString, ...) UGHLog::Warning(FString::Printf(TEXT(FormatString), ##__VA_ARGS__ ), LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_ERROR(FormatString, ...) UGHLog::Error(FString::Printf(TEXT(FormatString), ##__VA_ARGS__ ), LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_ERROR_CONSOLE(FormatString, ...) UGHLog::Error(FString::Printf(TEXT(FormatString), ##__VA_ARGS__ ), LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_ERROR_VIEWPORT(FormatString, ...) UGHLog::Error(FString::Printf(TEXT(FormatString), ##__VA_ARGS__ ), LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_VECTOR(Variable, ...) UGHLog::Vector(Variable, false, __VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_VECTOR_CONSOLE(Variable, ...) UGHLog::Vector(Variable, false, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_VECTOR_VIEWPORT(Variable, ...) UGHLog::Vector(Variable, false, __VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_VECTOR_COMPACT(Variable, ...) UGHLog::Vector(Variable, true, __VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_VECTOR_COMPACT_CONSOLE(Variable, ...) UGHLog::Vector(Variable, true, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_VECTOR_COMPACT_VIEWPORT(Variable, ...) UGHLog::Vector(Variable, true, __VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_VECTOR2D(Variable, ...) UGHLog::Vector2D(Variable, false,__VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_VECTOR2D_CONSOLE(Variable, ...) UGHLog::Vector2D(Variable, false, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_VECTOR2D_VIEWPORT(Variable, ...) UGHLog::Vector2D(Variable, false,__VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_VECTOR2D_COMPACT(Variable, ...) UGHLog::Vector2D(Variable, true,__VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_VECTOR2D_COMPACT_CONSOLE(Variable, ...) UGHLog::Vector2D(Variable, true, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_VECTOR2D_COMPACT_VIEWPORT(Variable, ...) UGHLog::Vector2D(Variable, true,__VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_ROTATOR(Variable, ...) UGHLog::Rotator(Variable, false, __VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_ROTATOR_CONSOLE(Variable, ...) UGHLog::Rotator(Variable, false, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_ROTATOR_VIEWPORT(Variable, ...) UGHLog::Rotator(Variable, false, __VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_ROTATOR_COMPACT(Variable, ...) UGHLog::Rotator(Variable, true, __VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_ROTATOR_COMPACT_CONSOLE(Variable, ...) UGHLog::Rotator(Variable, true, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_ROTATOR_COMPACT_VIEWPORT(Variable, ...) UGHLog::Rotator(Variable, true, __VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_TRANSFORM(Variable, ...) UGHLog::Transform(Variable, __VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_TRANSFORM_CONSOLE(Variable, ...) UGHLog::Transform(Variable, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_TRANSFORM_VIEWPORT(Variable, ...) UGHLog::Transform(Variable, __VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_QUAT(Variable, ...) UGHLog::Quat(Variable, false, __VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_QUAT_CONSOLE(Variable, ...) UGHLog::Quat(Variable, false, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_QUAT_VIEWPORT(Variable, ...) UGHLog::Quat(Variable, false, __VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_QUAT_COMPACT(Variable, ...) UGHLog::Quat(Variable, true, __VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_QUAT_COMPACT_CONSOLE(Variable, ...) UGHLog::Quat(Variable, true, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_QUAT_COMPACT_VIEWPORT(Variable, ...) UGHLog::Quat(Variable, true, __VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_MATRIX(Variable, ...) UGHLog::Matrix(Variable, __VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_MATRIX_CONSOLE(Variable, ...) UGHLog::Matrix(Variable, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_MATRIX_VIEWPORT(Variable, ...) UGHLog::Matrix(Variable, __VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_COLOR(Variable, ...) UGHLog::Color(Variable, false, __VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_COLOR_CONSOLE(Variable, ...) UGHLog::Color(Variable, false, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_COLOR_VIEWPORT(Variable, ...) UGHLog::Color(Variable, false, __VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_COLOR_COMPACT(Variable, ...) UGHLog::Color(Variable, true, __VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_COLOR_COMPACT_CONSOLE(Variable, ...) UGHLog::Color(Variable, true, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_COLOR_COMPACT_VIEWPORT(Variable, ...) UGHLog::Color(Variable, true, __VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_TRUE() UGHLog::Warning("True", LO_Both, false, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_TRUE_CONSOLE() UGHLog::Warning("True", LO_Console, false, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_TRUE_VIEWPORT() UGHLog::Warning("True", LO_Viewport, false, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_FALSE() UGHLog::Warning("False", LO_Both, false, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_FALSE_CONSOLE() UGHLog::Warning("False", LO_Console, false, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_FALSE_VIEWPORT() UGHLog::Warning("False", LO_Viewport, false, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_NUMBER(Variable, ...) UGHLog::Number(Variable, __VA_ARGS__, DLNS_Decimal, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_NUMBER_CONSOLE(Variable, ...) UGHLog::Number(Variable, __VA_ARGS__, DLNS_Decimal, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_NUMBER_VIEWPORT(Variable, ...) UGHLog::Number(Variable, __VA_ARGS__, DLNS_Decimal, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_BOOL(Variable, ...) UGHLog::Bool(Variable, __VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_BOOL_CONSOLE(Variable, ...) UGHLog::Bool(Variable, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_BOOL_VIEWPORT(Variable, ...) UGHLog::Bool(Variable, __VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

//#define LOG_ENUM(EnumType, Variable, bFriendlyName, ...) UGHLog::Enum<EnumType>(Variable, bFriendlyName, __VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
//#define LOG_ENUM_CONSOLE(EnumType, Variable, bFriendlyName, ...) UGHLog::Enum<EnumType>(Variable, bFriendlyName, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
//#define LOG_ENUM_VIEWPORT(EnumType, Variable, bFriendlyName, ...) UGHLog::Enum<EnumType>(Variable, bFriendlyName, __VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_ENUM(EnumType, Variable, bFriendlyName, ...) UGHLog::Enum<EnumType>(#EnumType, Variable, bFriendlyName, __VA_ARGS__, LO_Both, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_ENUM_CONSOLE(EnumType, Variable, bFriendlyName, ...) UGHLog::Enum<EnumType>(#EnumType, Variable, bFriendlyName, __VA_ARGS__, LO_Console, LOG_DEFAULT_DISPLAY_TIME)
#define LOG_ENUM_VIEWPORT(EnumType, Variable, bFriendlyName, ...) UGHLog::Enum<EnumType>(#EnumType, Variable, bFriendlyName, __VA_ARGS__, LO_Viewport, LOG_DEFAULT_DISPLAY_TIME)

#define LOG_LINEBREAK() UGHLog::LineBreak(LO_Both)
#define LOG_LINEBREAK_CONSOLE() UGHLog::LineBreak("", "", LO_Console)
#define LOG_LINEBREAK_VIEWPORT() UGHLog::LineBreak("", "", LO_Viewport)

#define LOG_LINEBREAK_S(Symbol) UGHLog::LineBreak_Symbol(#Symbol, LO_Both)
#define LOG_LINEBREAK_S_CONSOLE(Symbol) UGHLog::LineBreak_Symbol(#Symbol, LO_Console)
#define LOG_LINEBREAK_S_VIEWPORT(Symbol) UGHLog::LineBreak_Symbol(#Symbol, LO_Viewport)
#endif
 ...
 */
UCLASS(Abstract)
class LEVIATHAN_API UGHLog : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Debug", meta = (DevelopmentOnly, AdvancedDisplay = "ViewportKeyName", DefaultToSelf = "ContextObject", HidePin = "ContextObject"))
	static void Error(const FString& Message, ELoggingOptions LoggingOption = LO_Console, float TimeToDisplay = 5.0f, bool bAddPrefix = false, FName ViewportKeyName = NAME_None, UObject* ContextObject = nullptr);
	...
	static void Error_WithCondition(const FString& Message, bool bCondition, ELoggingOptions LoggingOption = LO_Console,  float TimeToDisplay = 5.0f, bool bAddPrefix = false, FName ViewportKeyName = NAME_None, UObject* ContextObject = nullptr);

	// Log a success message to the console or viewport
	UFUNCTION(BlueprintCallable, Category = "Debug", meta = (DevelopmentOnly, AdvancedDisplay = "ViewportKeyName", DefaultToSelf = "ContextObject", HidePin = "ContextObject"))
	static void Success(const FString& Message, ELoggingOptions LoggingOption = LO_Console, float TimeToDisplay = 5.0f, bool bAddPrefix = false,  FName ViewportKeyName = NAME_None, UObject* ContextObject = nullptr);
	...
	static void Success_WithCondition(const FString& Message, bool bCondition, ELoggingOptions LoggingOption = LO_Console, float TimeToDisplay = 5.0f, bool bAddPrefix = false,  FName ViewportKeyName = NAME_None, UObject* ContextObject = nullptr);

	// Log a warning message to the console or viewport
	UFUNCTION(BlueprintCallable, Category = "Debug", meta = (DevelopmentOnly, AdvancedDisplay = "ViewportKeyName", DefaultToSelf = "ContextObject", HidePin = "ContextObject"))
	static void Warning(const FString& Message, ELoggingOptions LoggingOption = LO_Console, float TimeToDisplay = 5.0f, bool bAddPrefix = false,  FName ViewportKeyName = NAME_None, UObject* ContextObject = nullptr);
	...
	static void Warning_WithCondition(const FString& Message, bool bCondition, ELoggingOptions LoggingOption = LO_Console, float TimeToDisplay = 5.0f,  bool bAddPrefix = false, FName ViewportKeyName = NAME_None, UObject* ContextObject = nullptr);

	// Log an information message to the console or viewport
	UFUNCTION(BlueprintCallable, Category = "Debug", meta = (DevelopmentOnly, AdvancedDisplay = "ViewportKeyName", DefaultToSelf = "ContextObject", HidePin = "ContextObject"))
	static void Info(const FString& Message, ELoggingOptions LoggingOption = LO_Console, float TimeToDisplay = 5.0f, bool bAddPrefix = false, FName ViewportKeyName = NAME_None, UObject* ContextObject = nullptr);
	...
	static void Info_WithCondition(const FString& Message, bool bCondition, ELoggingOptions LoggingOption = LO_Console, float TimeToDisplay = 5.0f, bool bAddPrefix = false, FName ViewportKeyName = NAME_None, UObject* ContextObject = nullptr);
...
private:
	...
	static class UGHDebugLogSettings* Settings;
...
template <typename T>
bool UGHLog::AssertEqual(T Actual, T Expected, FString AssertType, FString Message, bool bCrashOnFailure, ELoggingOptions LoggingOption, float TimeToDisplay, FName ViewportKeyName, UObject* ContextObject)
{
	...
	if (Actual != Expected)
	{
		if (bCrashOnFailure)
			...
			Error(AssertType + " | Assert Failed: " + Message, LoggingOption, TimeToDisplay, false, ViewportKeyName, ContextObject);
...
template <typename T>
bool UGHLog::AssertNotEqual(T Actual, T Expected, FString AssertType, FString Message, bool bCrashOnFailure, ELoggingOptions LoggingOption, float TimeToDisplay, FName ViewportKeyName, UObject* ContextObject)
{
#if !(UE_BUILD_SHIPPING || UE_BUILD_TEST)
	if (Actual == Expected)
	{
...
template <typename T>
bool UGHLog::AssertEqual(T* Actual, T* Expected, FString AssertType, const FString Message, const bool bCrashOnFailure, ELoggingOptions LoggingOption, float TimeToDisplay, FName ViewportKeyName, UObject* ContextObject)
{
#if !(UE_BUILD_SHIPPING || UE_BUILD_TEST)
	if (Actual != Expected)
	{
...
template <typename T>
bool UGHLog::AssertNotEqual(T* Actual, T* Expected, FString AssertType, const FString Message, const bool bCrashOnFailure, ELoggingOptions LoggingOption, float TimeToDisplay, FName ViewportKeyName, UObject* ContextObject)
{
#if !(UE_BUILD_SHIPPING || UE_BUILD_TEST)
	if (Actual == Expected)
	{
...
template <typename T>
bool UGHLog::AssertValue(T Actual, T Expected, const EDebugLogComparisonMethod ComparisonMethod, FString AssertType, const FString Message, const bool bCrashOnFailure, ELoggingOptions LoggingOption, float TimeToDisplay, FName ViewportKeyName, UObject* ContextObject)
{
#if !(UE_BUILD_SHIPPING || UE_BUILD_TEST)
...
template <typename T>
bool UGHLog::PerformComparison(T LHS, T RHS, const EDebugLogComparisonMethod ComparisonMethod)
{
#if !(UE_BUILD_SHIPPING || UE_BUILD_TEST)
...
template <typename EnumType>
void UGHLog::Enum(const FString& EnumTypeString, const EnumType& EnumValue, const bool bFriendlyName, const FString& Prefix, const FString& Suffix, const ELoggingOptions& LoggingOption, const float TimeToDisplay, const FName ViewportKeyName, UObject* ContextObject)
{
	UEnum* EnumObject = FindObject<UEnum>(nullptr, *EnumTypeString, true);
	if (EnumObject)
	{
		if (bFriendlyName)
		{
...
template <typename EnumType>
void UGHLog::Enum(const FString& EnumTypeString, const EnumType& EnumValue, const bool bFriendlyName, const ELoggingOptions& LoggingOption, const float TimeToDisplay, const FName ViewportKeyName, UObject* ContextObject)
{
